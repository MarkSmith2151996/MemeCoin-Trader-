"""Detached paper-only MT-444 momentum trailing-exit collector — faster 15s marks."""
...
REPORT_PATH = Path("/mnt/c/Users/Big A/custodian-shared/memecoin-trader/paper-trade-reports/momentum_tuned_v3_batch.md")
CSV_PATH = Path("/mnt/c/Users/Big A/custodian-shared/memecoin-trader/paper-trade-reports/momentum_tuned_v3_trade_log.csv")
HOLD_SECONDS = 30 * 60
MARK_INTERVAL_SECONDS = 15
AMOUNT_SOL = 0.01
MAX_ENTRIES = 3
...
def _write_outputs(rows, signals, repeats, fallback_count, passes, quotes, blocked, records) -> None:
    ...
    lines = [
        "# Momentum Tuned V3 Paper Batch (15s Marks)",
        "",
        ...
        "- MT-439 tuned exit parameters: hard stop -20%; activation +10%; standard trail 8%; tightened trail +25%/5%; max hold 30m.",
        f"- Mark interval: 15s (MT-444 change from 60s)",
