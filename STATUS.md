...
- Full `python3 -m pytest` currently has unrelated failures in `tests/test_onchain_provider.py`; the latest discovery holder-lookup work did not touch `src/signals/onchain.py` or its tests.
